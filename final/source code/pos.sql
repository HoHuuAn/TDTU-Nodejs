...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 17, 2023 at 07:29 AM
...
(5, 'hoan0906881769@gmail.com', '$2b$10$hbsaNT72EGcbdn4DXSEsRuLbOnMqp3gtAkPK8taNbdA0oiIaPEXMa', 'hoan0906881769');
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `quantity` int DEFAULT NULL,
  `barcode` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `image` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `avatar` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `lock_status` int NOT NULL DEFAULT '0',
  `createdAt` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(5, 'Ho Huu An', 20, 909056983, 'HCMC', 1, 'User', 5, 'deafaultmen.jpg', 0, '2023-12-16 17:03:47', 1);
